...
/** Utility to decode GIF Images to libgdx compatible formats */
...
public class GifDecoder {
	...
	/** Iteration count (0: repeat forever) */
	...
	/** 0: no action; 1: leave in place; 2: restore to background; 3: restore to previous; */
	...
	public int read(InputStream is) {
		...
		try {
			...
			System.err.println("GifDecoder: Could not close Gif Stream!");
		}
		return status;
	}
